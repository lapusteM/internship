  ...
  *
  *
  * Updated by Radu B. Gaspar http://gotoandlearn.ro
  *   added canvas element offsetX and offsetY support
  *   added auto play option
  *   added reverse play support
  *   added reverse loop support
  *
  * small bugs, don't use for production!
  * DEMO PURPOSES ONLY!
  */
    ...
    return this.each(function() {
      ...
      resource.onload = function() {
          ...
          var updateCanvas = function() {
            ...
            context.clearRect(opts.offsetX, opts.offsetY, opts.frameWidth, opts.frameHeight);
            context.drawImage(resource, xGrid, yGrid, opts.frameWidth, opts.frameHeight, opts.offsetX, opts.offsetY, opts.frameWidth, opts.frameHeight);
          };
